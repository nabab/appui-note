<div class="appui-note-forum-topic-post bbn-bordered bbn-background bbn-radius bbn-w-100">
  <div class="bbn-flex-width bbn-radius">
    <!-- Left block -->
    <div class="bbn-radius-left bbn-alt-background"
         style="width: 130px; min-width: 12em; max-width: 25em">
      <div class="bbn-w-100 bbn-vmiddle">
        <!-- Author -->
        <div class="appui-note-forum-topic-post-minwidth bbn-unselectable">
          <span class="bbn-right-sspace bbn-vmiddle"
                :title="usersNames">
            ...
            <span class="bbn-xspadded bbn-s bbn-unselectable bbn-nowrap bbn-ellipsis"
        ...
        <div v-if="!isTopic && isSubReply"
          ...
          <span class="bbn-vmiddle bbn-right-xspadded bbn-radius bbn-alt-background bbn-alt-text bbn-bordered bbn-right-sspace">
      ...
      <div class="bbn-w-100" style="padding-left: 1.5rem">
        <!-- Datetime -->
        <div v-text="ndatetime(isEdited ? source.last_edit : source.creation)"
             :title="isEdited ? _('Updated at') : _('Created at')"
             class="appui-note-forum-topic-post-minwidth bbn-s bbn-vmiddle bbn-nowrap bbn-left-xsspace"/>
        <!-- Buttons -->
        <div class="bbn-left-xsspace">
          <div class="bbn-vmiddle">
            ...
            <bbn-button v-if="!isTopic && forum.replyButtons && forum.replyButtons.length"
                        ...
                        :title="btn.title || ''"/>
            <!-- Reply -->
            <bbn-button icon="nf nf-fa-reply"
                        :notext="true"
    ...
    <div class="bbn-flex-fill bbn-spadding">
      <!-- Line 1 -->
      <div class="bbn-nl bbn-bottom-xsspace bbn-vmiddle">
        <!-- Category -->
        <div v-if="isTopic && category"
             class="appui-note-forum-topic-post-minwidth bbn-s bbn-vmiddle bbn-radius bbn-xspadded bbn-alt-background bbn-alt-text bbn-hsspace bbn-bordered bbn-block"
             v-text="category"/>
        <!-- Title -->
        <div v-if="isTopic && source.title"
             class="bbn-hsspace bbn-block"
      ...
      <div class="bbn-nl">
        <!-- Content -->
        <div :class="['bbn-right-sspace', {'bbn-left-sspace': isTopic}]"
             style="overflow: hidden">
    ...
    <!-- Right block -->
    <div class="bbn-radius-right bbn-alt-background">
      <!-- Line 1 -->
      <div class="bbn-w-100">
        <!-- Links -->
        ...
        <div v-if="isTopic">
          <div title="<?=_('Replies')?>"
               :class="['bbn-alt-background', 'bbn-alt-text', 'bbn-radius', 'bbn-p bbn-xspadded', 'bbn-vmiddle', 'bbn-bordered', 'bbn-reactive', {'bbn-disabled': !source.num_replies}]"
